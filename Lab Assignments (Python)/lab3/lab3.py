...
class Player:
    ...
    def move(self, current: int, min_step: int, max_step: int, goal: int) -> int:
        """
        Moves count by Number a player chooses.
        """
...
class RandomPlayer(Player):
    """
    Picks random move from among legal possibilities
    """
...
def make_player(generic_name: str) -> Player:
    ...
    player_type = input(f"Choose a player type: {Player}")
